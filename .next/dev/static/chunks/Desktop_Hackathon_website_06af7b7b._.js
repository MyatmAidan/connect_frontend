...
"[project]/Desktop/Hackathon/website/api/reports.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getReportsApi(params = {}) {
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get("/reports", {
...
async function getReportByIdApi(id) {
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(`/reports/${id}`);
    const body = result;
    return body.data;
}
async function reviewReportApi(id) {
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post(`/reports/${id}/review`);
    const body = result;
    return body.data;
}
async function resolveReportApi(id) {
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post(`/reports/${id}/resolve`);
    const body = result;
    return body.data;
}
async function rejectReportApi(id) {
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post(`/reports/${id}/reject`);
    const body = result;
    return body.data;
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
"[project]/Desktop/Hackathon/website/app/[locale]/reports/_components/ReportsListContainer.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$components$2f$common$2f$RowActions$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Hackathon/website/components/common/RowActions.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$components$2f$common$2f$StatusBadge$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Hackathon/website/components/common/StatusBadge.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$reports$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Hackathon/website/api/reports.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$pagination$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Hackathon/website/lib/pagination.ts [app-client] (ecmascript)");
...
function ReportsListContainer() {
    ...
    const apiDataSource = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReportsListContainer.useMemo[apiDataSource]": ()=>({
                fetchFunction: ({
                    "ReportsListContainer.useMemo[apiDataSource]": async (page, pageSize)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$pagination$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toTableResponse"])(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$reports$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getReportsApi"])({
                            page,
                            per_page: pageSize,
    ...
    const columns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ReportsListContainer.useMemo[columns]": ()=>[
                {
                    accessorKey: "reason",
                ...
                },
                {
                    ...
                    cell: {
                        "ReportsListContainer.useMemo[columns]": ({ row })=>row.original.reporter?.name
                    }["ReportsListContainer.useMemo[columns]"]
                },
                {
                    header: t("reports.reportedUser"),
                    cell: {
                        "ReportsListContainer.useMemo[columns]": ({ row })=>row.original.reported_user?.name
                    }["ReportsListContainer.useMemo[columns]"]
                },
                {
                    accessorKey: "status",
                ...
                },
                {
                    ...
                    cell: {
                        "ReportsListContainer.useMemo[columns]": ({ row })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$date$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(row.original.created_at)
                    }["ReportsListContainer.useMemo[columns]"]
                },
                {
                    id: "actions",
                    ...
                    cell: {
                        "ReportsListContainer.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$components$2f$common$2f$RowActions$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RowActions"], {
                                viewHref: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$locale$2d$path$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["localePath"])(locale, `/reports/${row.original.id}`)
                            }, void 0, false, {
                                fileName: "[project]/Desktop/Hackathon/website/app/[locale]/reports/_components/ReportsListContainer.tsx",
                                lineNumber: 54,
                                columnNumber: 11
...
_s(ReportsListContainer, "HU3a+Diogv5itZiciYPjjIL/R00=", false, function() {
    return [
...
_c = ReportsListContainer;
var _c;
__turbopack_context__.k.register(_c, "ReportsListContainer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Desktop_Hackathon_website_06af7b7b._.js.map