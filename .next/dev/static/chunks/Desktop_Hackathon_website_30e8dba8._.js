...
"[project]/Desktop/Hackathon/website/api/logs.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getAdminLogsApi(params = {}) {
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get("/logs", {
...
async function getAdminLogByIdApi(id) {
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get(`/logs/${id}`);
    const body = result;
    return body.data;
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
"[project]/Desktop/Hackathon/website/app/[locale]/logs/_components/LogsListContainer.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$components$2f$common$2f$PageHeader$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Hackathon/website/components/common/PageHeader.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$components$2f$common$2f$RowActions$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Hackathon/website/components/common/RowActions.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$logs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Hackathon/website/api/logs.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$pagination$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Hackathon/website/lib/pagination.ts [app-client] (ecmascript)");
...
function LogsListContainer() {
    ...
    const apiDataSource = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LogsListContainer.useMemo[apiDataSource]": ()=>({
                fetchFunction: ({
                    "LogsListContainer.useMemo[apiDataSource]": async (page, pageSize)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$pagination$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toTableResponse"])(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$logs$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAdminLogsApi"])({
                            page,
                            per_page: pageSize
                        }))
                })["LogsListContainer.useMemo[apiDataSource]"]
    ...
    const columns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LogsListContainer.useMemo[columns]": ()=>[
                {
                    accessorKey: "action",
                ...
                },
                {
                    header: t("logs.admin"),
                    cell: {
                        "LogsListContainer.useMemo[columns]": ({ row })=>row.original.admin?.name
                    }["LogsListContainer.useMemo[columns]"]
                },
                {
                ...
                },
                {
                    ...
                    cell: {
                        "LogsListContainer.useMemo[columns]": ({ row })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$date$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(row.original.created_at)
                    }["LogsListContainer.useMemo[columns]"]
                },
                {
                    id: "actions",
                    ...
                    cell: {
                        "LogsListContainer.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$components$2f$common$2f$RowActions$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RowActions"], {
                                viewHref: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$locale$2d$path$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["localePath"])(locale, `/logs/${row.original.id}`)
                            }, void 0, false, {
...
_s(LogsListContainer, "fXdy+HtMACqBIZ9JHWCBsG/hWno=", false, function() {
    return [
...
_c = LogsListContainer;
var _c;
__turbopack_context__.k.register(_c, "LogsListContainer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Desktop_Hackathon_website_30e8dba8._.js.map