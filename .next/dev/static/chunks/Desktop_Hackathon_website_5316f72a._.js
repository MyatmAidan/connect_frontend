...
"[project]/Desktop/Hackathon/website/app/[locale]/profiles/_components/ProfilesListContainer.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ProfilesListContainer() {
    ...
    const apiDataSource = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProfilesListContainer.useMemo[apiDataSource]": ()=>({
                fetchFunction: ({
                    "ProfilesListContainer.useMemo[apiDataSource]": async (page, pageSize)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$pagination$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toTableResponse"])(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$developer$2d$profiles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDeveloperProfilesApi"])({
                            page,
                            per_page: pageSize
                        }))
                })["ProfilesListContainer.useMemo[apiDataSource]"]
    ...
    const columns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ProfilesListContainer.useMemo[columns]": ()=>[
                {
                    accessorKey: "user.name",
                    header: t("users.name"),
                    cell: {
                        "ProfilesListContainer.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                href: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$locale$2d$path$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["localePath"])(locale, `/profiles/${row.original.id}`),
                ...
                },
                {
                    ...
                    cell: {
                        "ProfilesListContainer.useMemo[columns]": ({ row })=>row.original.category?.name ?? t("common.notAvailable")
                    }["ProfilesListContainer.useMemo[columns]"]
                },
                {
                ...
                },
                {
                    ...
                    cell: {
                        "ProfilesListContainer.useMemo[columns]": ({ row })=>row.original.is_public ? t("common.yes") : t("common.no")
                    }["ProfilesListContainer.useMemo[columns]"]
                },
                {
                    id: "actions",
                    ...
                    cell: {
                        "ProfilesListContainer.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$components$2f$common$2f$RowActions$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RowActions"], {
                                viewHref: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$locale$2d$path$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["localePath"])(locale, `/profiles/${row.original.id}`),
                                editHref: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$locale$2d$path$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["localePath"])(locale, `/profiles/${row.original.id}/edit`),
                                onDelete: {
                                    "ProfilesListContainer.useMemo[columns]": ()=>setDeleteTarget(row.original)
                                }["ProfilesListContainer.useMemo[columns]"]
                            }, void 0, false, {
                                fileName: "[project]/Desktop/Hackathon/website/app/[locale]/profiles/_components/ProfilesListContainer.tsx",
                                lineNumber: 62,
    ...
    const handleDelete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProfilesListContainer.useCallback[handleDelete]": async ()=>{
            if (!deleteTarget) return;
            setDeleting(true);
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$developer$2d$profiles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteDeveloperProfileApi"])(deleteTarget.id);
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(t("profiles.deleted"));
                setDeleteTarget(null);
                setRefreshTrigger({
                    "ProfilesListContainer.useCallback[handleDelete]": (n)=>n + 1
                }["ProfilesListContainer.useCallback[handleDelete]"]);
            } catch  {
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(t("profiles.deleteFailed"));
            } finally{
                setDeleting(false);
            }
        }
...
_s(ProfilesListContainer, "HDEcApbrjHfQ827xIitQPP2N8IA=", false, function() {
    return [
...
_c = ProfilesListContainer;
var _c;
__turbopack_context__.k.register(_c, "ProfilesListContainer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Desktop_Hackathon_website_5316f72a._.js.map