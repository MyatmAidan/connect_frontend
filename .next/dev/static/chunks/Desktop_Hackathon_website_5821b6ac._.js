...
"[project]/Desktop/Hackathon/website/app/[locale]/event-requests/_components/EventRequestsListContainer.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EventRequestsListContainer() {
    ...
    const apiDataSource = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EventRequestsListContainer.useMemo[apiDataSource]": ()=>({
                fetchFunction: ({
                    "EventRequestsListContainer.useMemo[apiDataSource]": async (page, pageSize)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$pagination$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toTableResponse"])(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$event$2d$requests$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getEventRequestsApi"])({
                            page,
                            per_page: pageSize,
    ...
    const columns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "EventRequestsListContainer.useMemo[columns]": ()=>[
                {
                    accessorKey: "title",
                ...
                },
                {
                    ...
                    cell: {
                        "EventRequestsListContainer.useMemo[columns]": ({ row })=>row.original.event_date ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$date$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(row.original.event_date, "PP") : "—"
                    }["EventRequestsListContainer.useMemo[columns]"]
                },
                {
                    header: t("eventRequests.requester"),
                    cell: {
                        "EventRequestsListContainer.useMemo[columns]": ({ row })=>row.original.user?.name
                    }["EventRequestsListContainer.useMemo[columns]"]
                },
                {
                    accessorKey: "status",
                ...
                },
                {
                    ...
                    cell: {
                        "EventRequestsListContainer.useMemo[columns]": ({ row })=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$date$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDate"])(row.original.created_at, "PP")
                    }["EventRequestsListContainer.useMemo[columns]"]
                },
                {
                    id: "actions",
                    ...
                    cell: {
                        "EventRequestsListContainer.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$components$2f$common$2f$RowActions$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RowActions"], {
                                viewHref: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$locale$2d$path$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["localePath"])(locale, `/event-requests/${row.original.id}`)
                            }, void 0, false, {
                                fileName: "[project]/Desktop/Hackathon/website/app/[locale]/event-requests/_components/EventRequestsListContainer.tsx",
                                lineNumber: 59,
                                columnNumber: 11
...
_s(EventRequestsListContainer, "HU3a+Diogv5itZiciYPjjIL/R00=", false, function() {
    return [
...
_c = EventRequestsListContainer;
var _c;
__turbopack_context__.k.register(_c, "EventRequestsListContainer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Desktop_Hackathon_website_5821b6ac._.js.map