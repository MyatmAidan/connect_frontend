...
"[project]/Desktop/Hackathon/website/api/skills.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getSkillsApi(params = {}) {
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].get("/skills", {
...
async function createSkillApi(payload) {
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].post("/skills", buildSkillFormData(payload));
    const body = result;
    return body.data;
}
async function updateSkillApi(id, payload) {
    ...
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].put(`/skills/${id}`, form);
    const body = result;
    return body.data;
}
async function deleteSkillApi(id) {
    await __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].delete(`/skills/${id}`);
}
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/Desktop/Hackathon/website/app/[locale]/skills/_components/SkillsListContainer.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$components$2f$common$2f$PageHeader$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Hackathon/website/components/common/PageHeader.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$components$2f$common$2f$RowActions$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Hackathon/website/components/common/RowActions.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$skills$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Hackathon/website/api/skills.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$pagination$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Hackathon/website/lib/pagination.ts [app-client] (ecmascript)");
...
function SkillsListContainer() {
    ...
    const apiDataSource = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SkillsListContainer.useMemo[apiDataSource]": ()=>({
                fetchFunction: ({
                    "SkillsListContainer.useMemo[apiDataSource]": async (page, pageSize, search)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$pagination$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toTableResponse"])(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$skills$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSkillsApi"])({
                            page,
                            per_page: pageSize,
                            search
                        }))
    ...
    const columns = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SkillsListContainer.useMemo[columns]": ()=>[
                {
                    id: "image",
                    header: t("skills.image"),
                    cell: {
                        "SkillsListContainer.useMemo[columns]": ({ row })=>{
                            const imageUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$media$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["resolveMediaUrl"])(row.original.image);
                            return imageUrl ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                },
                {
                    ...
                    cell: {
                        "SkillsListContainer.useMemo[columns]": ({ row })=>row.original.category?.name ?? t("common.notAvailable")
                    }["SkillsListContainer.useMemo[columns]"]
                },
                {
                    id: "actions",
                    ...
                    cell: {
                        "SkillsListContainer.useMemo[columns]": ({ row })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$components$2f$common$2f$RowActions$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["RowActions"], {
                                editHref: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$locale$2d$path$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["localePath"])(locale, `/skills/${row.original.id}/edit`),
                                onDelete: {
                                    "SkillsListContainer.useMemo[columns]": ()=>setDeleteTarget(row.original)
                                }["SkillsListContainer.useMemo[columns]"]
                            }, void 0, false, {
                                fileName: "[project]/Desktop/Hackathon/website/app/[locale]/skills/_components/SkillsListContainer.tsx",
                                lineNumber: 66,
    ...
    const handleDelete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "SkillsListContainer.useCallback[handleDelete]": async ()=>{
            if (!deleteTarget) return;
            setDeleting(true);
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$api$2f$skills$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteSkillApi"])(deleteTarget.id);
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(t("skills.deleted"));
                setDeleteTarget(null);
                setRefreshTrigger({
                    "SkillsListContainer.useCallback[handleDelete]": (n)=>n + 1
                }["SkillsListContainer.useCallback[handleDelete]"]);
            } catch  {
                __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(t("skills.deleteFailed"));
            } finally{
                setDeleting(false);
            }
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$components$2f$common$2f$PageHeader$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PageHeader"], {
                title: t("menu.skills"),
                createHref: (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Hackathon$2f$website$2f$lib$2f$locale$2d$path$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["localePath"])(locale, "/skills/create"),
...
_s(SkillsListContainer, "HDEcApbrjHfQ827xIitQPP2N8IA=", false, function() {
    return [
...
_c = SkillsListContainer;
var _c;
__turbopack_context__.k.register(_c, "SkillsListContainer");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=Desktop_Hackathon_website_9a8a9347._.js.map